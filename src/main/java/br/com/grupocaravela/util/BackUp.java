...
public class BackUp {
	...
	private void salvar(String nome) {
		...
		if ("Linux".equals(System.getProperty("os.name"))) {
			...
			dumps = new String[] {"cmd.exe", "/c", "C:\\GrupoCaravela\\gestor\\backup\\x64\\mysqldump.exe -h " + Empresa.getIpServidor() + " -u root -ppeperoni desbravar > " + nome + ".sql"};
		}
	...
	private void upload(String nome){
		...
		if ("Linux".equals(System.getProperty("os.name"))) {
			...
			dumps = new String[] {"cmd.exe", "/c", "C:\\GrupoCaravela\\gestor\\backup\\x64\\mysql.exe -h " + Empresa.getIpServidor() + " -u root -ppeperoni desbravar < " + nome};
