...
public class JanelaDebito extends JFrame {
	...
	private JDateChooser dcDataDebito;
	/**
	...
	public void carregarJanela(){
		...
		tabbedPane.addTab("Lista de débitos", null, panel_1, null);
		...
		button.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/lupa_24.png")));
		...
		btnNovo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dcDataDebito.setDate(dataAtual());
				
				tabbedPane.setSelectedIndex(1);
			}
		});
		btnNovo.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/novo_24.png")));
		...
		btnDetalhes.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/alterar_24.png")));
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null,
						"ATENÇÃO!!! Esta operação irá excluir o débito selecionado! Gostaria de continuar?",
				...
				if (i == JOptionPane.YES_OPTION) {
			        ...
			        Debito c = tableModelDebito.getDebito(linhaReal);
		...
		btnExcluir.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/alerta_vermelho_24.png")));
		...
		tabbedPane.addTab("Detalhes do débito", null, panel_2, null);
		...
		JLabel lblDataDbito = new JLabel("Data débito:");
		
		dcDataDebito = new JDateChooser();
			...
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(lblPessoa, Alignment.LEADING)
						.addGroup(Alignment.LEADING, gl_panel_2.createSequentialGroup()
						...
						.addGroup(Alignment.LEADING, gl_panel_2.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
								.addComponent(dcDataDebito, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblDataDbito))
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING, false)
							...
							.addGroup(gl_panel_2.createSequentialGroup()
								...
								.addComponent(dcDataDebito, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel_2.createSequentialGroup()
							.addComponent(lblValor)
							.addPreferredGap(ComponentPlacement.RELATED)
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Object[] options = { "Sim", "Não" };
				int i = JOptionPane.showOptionDialog(null,
						"Gostaria de salvar o Débito no valor de " + tfValor.getText() + "?", "Salvar",
		...
		btnSalvar.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/alerta_verde_24.png")));
		...
		btnCancelar.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
		...
		btnVoltar.setIcon(new ImageIcon(JanelaDebito.class.getResource("/br/com/grupocaravela/icones/voltar_24.png")));
	...
	private void carregarTableModel() {
		...
		this.table.setModel(tableModelDebito);
	...
	private void buscarNome(String nome){		
		try {
			...
			Query consulta = manager
					.createQuery("FROM Debito WHERE nome LIKE '%" + nome + "%'");
	...
	private void carregarCampos(Debito c){
		
		tfId.setText(c.getId().toString());
		tfNome.setText(c.getNome());
		tfValor.setText(c.getValor().toString());
		dcDataCriacao.setDate(c.getDataCriacao());
		dcDataDebito.setDate(c.getDataDebito());
	...
	private void excluirDebito(Debito c){
        ...
        try {
			...
			JOptionPane.showMessageDialog(null, "O debito foi excluido com sucesso!");
		} catch (Exception e) {
			JOptionPane.showMessageDialog(null, "ERRO! " + e);
		}		
	}
	
	private void salvarDebito(Debito c){
		try {

			c.setDataCriacao(dcDataCriacao.getDate());
			c.setDataDebito(dcDataDebito.getDate());
			...
			JOptionPane.showMessageDialog(null, "O débio foi salvo com sucesso!");						
	...
	private void botaoDetalhes(){
		...
		final Thread tr = new Thread(new Runnable() {
			...
			public void run() {
				...
				int linha = table.getSelectedRow();
		        int linhaReal = table.convertRowIndexToModel(linha);		
		        debito = tableModelDebito.getDebito(linhaReal);
				
				carregarCampos(debito);
				tabbedPane.setSelectedIndex(1);
